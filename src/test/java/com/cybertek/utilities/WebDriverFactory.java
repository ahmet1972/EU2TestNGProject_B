    ...
    public static WebDriver getDriver(String browserType){
        ...
        switch (browserType.toLowerCase()){
            case "chrome":
                ...
                driver=new ChromeDriver(); // consider that "WebDriver" is a data type and a variable with WebDriver type
                break;                    //is being declared and intialized to null five lines above before swith-case
            case "firefox":
