...
public class ExtentDemoTest {
    ...
    public void setUp(){
        ...
        String projectPath = System.getProperty("user.dir"); //We used that line in FilePathExample class
    ...
    public void test1(){
        ...
        //test steps -- TestNg does not give results against the test steps that's why we do below lines
